...
ggplot(Death_rate,aes(x = percent, y = Average_life_expectancy)) +
  ...
  labs(title = "Relationship between Life Expectancy and Air Pollution", x = "Air Pollution Percent", y = "Life expectancy") +
